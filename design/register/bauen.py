...
<div class="seite">
  <header class="kopfz">
    ...
    K77–K88, aus fünfzehn Aufnahmen — vier Empfänger aus den Siebzigern, ein
    ...
    Vorlagen liegen unter <code>mckups_player_3/</code>. Zwei davon bringen etwas, das im ganzen
    Register sonst fehlt: <b>K80 Automatik</b> einen Direktzugriff, der die Sammlung überspringt,
    und <b>K87 Anschlag</b> die einzige Oberfläche, die <b>kein Gerät nachbaut</b>, sondern ein
    Plakat ist.</p>
    ...
    <p class="lede"><b>Ganz am Ende stehen drei Blätter, die kein neues Vorbild haben.</b>
    K89 Bogen, K90 Nachtglas und K91 Rundlauf sind die vorstehenden 88 noch einmal gelesen:
    <b>ein Aufbau in drei Materialien</b> — Papier, Glas, Metall. Sie teilen sich Maßband,
    Schriftleiter, Satzspiegel und Bedienreihe (<code>design/entwuerfe/src/kanon.py</code>)
