...
<div class="seite">
  <header class="kopfz">
    ...
    <h1>Achtundachtzig Spieler, <em>vier</em> Zustände</h1>
    ...
    Nummernfolge. Die Nummer <code>K01</code>–<code>K88</code> ist
    ...
    Blättern aus dem Blatt; bei den <b>41 Standbildern (K48–K88) ist sie ein Vorschlag</b> und
  ...
  <div class="werkzeug">
    ...
    <span class="treffer" id="treffer">88 von 88</span>
